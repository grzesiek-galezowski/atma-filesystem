...
{
  static internal class ExceptionMessages
  {
    public static readonly string RootedPathsAreIllegalPleasePassARelativePath = "Rooted paths are illegal, please pass a relative path";
